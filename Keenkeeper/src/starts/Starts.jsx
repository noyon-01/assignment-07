...
//       <h1 className="text-3xl md:text-5xl font-bold mb-6">Friendship Analytics</h1>

//   <div className="bg-white shadow rounded p-8">
//         <h2 className="text-[#244D3F] text-xl font-semibold">By Interaction Type</h2>
  ...
  return (
    <div className="w-9/12 py-20 mx-auto">
      ...
      <div className="bg-white shadow rounded p-8">
        ...
        {/* ✅ Show "No available data" when totalData is 0 */}
        {totalData === 0 ? (
